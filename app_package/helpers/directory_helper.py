...
FINAL_REEL_RENDER = os.path.join(BASE_DIR, "../../final_render")
EXTRACT_AUDIO_DIR = os.path.join(BASE_DIR, "../../extracted_audio")
CONVERTED_FPS_DIR = os.path.join(BASE_DIR, "../../converted_fps")